...
public sealed class LogInQueryHandler(IUserRepository userRepository, ITokenService tokenService) : IRequestHandler<LogInQuery, Result<ResponseType<UserLogInResponseDto>>>
{
