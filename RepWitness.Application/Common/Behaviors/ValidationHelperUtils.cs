...
{
    public static KeyValuePair<bool, string> ValidateRequiredFields<T>(T request, string[]? ignoreNames = null) where T : class
    {
        ...
        {
            if (ignoreNames != null && ignoreNames.Contains(property.Name)) continue;
    ...
    private static bool IsNullOrDefault(object? value)
    {
        ...
        if (type == typeof(bool) || type == typeof(int)) return false;
